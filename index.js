...
app.get(/^(.+)$/, function(req,res,next){
	switch(req.params[0]){
		case '/':
			var body="<style>body{	background-image:url('background.png');	background-size:cover;	background-repeat: no-repeat; }h1{font-family:sans-serif; font-size: xx-large; color:#a71e1e;}h2{ font-size: large; font-family:sans-serif; color:#a71e1e;}</style><script>var connection = new WebSocket('wss://"+HOSTIP+":8443/' , ['soap','xmpp']);connection.onmessage = function (e) {        if (e.data == 'usuario logueado'){window.location = 'https://"+PKGCLOUD+":3000/html/combos.html';}console.log('Server: ' + e.data);};</script><h1 style='margin:5% auto auto auto; text-align:center'>Demo01 Managed Cloud</h1><table style='margin-top:7%'><tbody><tr><td align='center' style='width:10%'><h2>Login</h2></td><td align='center'style='width:10%'><h2>Registrarse</h2></td></tr><tr><td><img src='login.png' style='display:block;  margin:auto; width:30%'></td><td><img src='registro.png' style='display:block;  margin:auto; width:30%'></td></tr></tbody></table>";
